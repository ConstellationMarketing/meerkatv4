...
const LANGUAGE_CONFIGS = {
  es: {
    name: 'Spanish',
    dialect: 'neutral Latin American Spanish',
    htmlLang: 'es',
    label: 'Español',
  },
  vi: {
    name: 'Vietnamese',
    dialect: 'Vietnamese using the Southern dialect (as spoken in Ho Chi Minh City)',
    htmlLang: 'vi',
    label: 'Tiếng Việt',
  },
};
...
async function runTranslation(articleId, language) {
  ...
  const translatedHtml = response.content[0].text.trim();
